...
const LogOutModal = ({  isOpen, onRequestClose, title, content, confirmText, onConfirm }) => {
  if (!isOpen) {
    return null;
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto">
      <div className="relative w-auto max-w-lg p-4 mx-auto my-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="p-6">
          <h3 className="text-lg font-medium text-gray-900"> Are you sure you wan to Logout?</h3>
